...
for index, row in all_data.iterrows():
    ...
    all_data.at[index, 'Flight_time'] = row_time
    all_data.at[index, 'Scheduled_arrival'] = actual_arrival

# Save the combined data to an Excel file
final_output_filename = r"C:\Users\kiran\OneDrive\Desktop\Files\Step2\Flight_Delay_Predection\Data\Scraped_data_final14.xlsx"
